...
var svg, rect, polyline;//=document.createElementNS(NS,"svg");
...
function init() 
{
	...
	//rect.width.baseVal.value=400;
	 //rect.height.baseVal.value=300;
	...
	//var point = svg.createSVGPoint(0,0); 
	polyline.setAttributeNS(null, "points", "0, 20 20, 20 30, 40 40, 40 60, 60"); 
	polyline.setAttributeNS(null, "stroke", "white");
...
//	polyline.setAttributeNS(null, "points", randomRange(0,100)+", "+randomRange(0,100)+" "+randomRange(0,100)+", "+randomRange(0,100)+" "+randomRange(0,100)+", "+randomRange(0,100)+" "+randomRange(0,100)+", "+randomRange(0,100)+" "+randomRange(0,100)+", "+randomRange(0,100)); 
...
function render() { 
	...
	while(polyline.transform.baseVal.numberOfItems<2) { 
		polyline.transform.baseVal.appendItem(svg.createSVGTransform()); 
	}
	var t = polyline.transform.baseVal.getItem(0); 
	t.setTranslate(view.x, view.y); 
	t = polyline.transform.baseVal.getItem(1); 
	t.setScale(view.scale, view.scale); 
	
	polyline.style.strokeWidth = 1/view.scale;
	landscape.render(polyline, view);
