...
int const A_END_STOP_MIN_PIN = 21; // pin 21
int const A_END_STOP_MAX_PIN = 20; // pin 20
int const B_END_STOP_MIN_PIN = 19; // pin 19
int const B_END_STOP_MAX_PIN = 18; // pin 18
