...
void changeDataScale(float scaleMultiplier) { 
  ...
  float oldWidth =  plotWidth / scaleToPlotter / dataScale;    
  float oldHeight =  plotHeight / scaleToPlotter / dataScale; 
  dataScale *=scaleMultiplier;  
  float newWidth =  plotWidth / scaleToPlotter / dataScale; 
  float newHeight =  plotHeight / scaleToPlotter / dataScale; 
  float offsetChangeX = ((newWidth-oldWidth)/2f);
  float offsetChangeY = ((newHeight-oldHeight)/2f);



  // println("offset increased by : "+ offsetChange + " ");
