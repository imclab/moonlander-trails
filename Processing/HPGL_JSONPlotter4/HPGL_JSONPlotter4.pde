...
Date startTime = new Date("04/17/2013");  // MM/DD/YY
...
void setup() {
  ...
  println("LOADING " +"http://node.seb.ly:8002/"+getDateStringReverse(startTime)+".json"); 
  String[] datas = loadStrings("http://node.seb.ly:8002/"+getDateStringReverse(startTime)+".json"); 
